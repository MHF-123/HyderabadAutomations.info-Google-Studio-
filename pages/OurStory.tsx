        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center">
            <h1 className="text-4xl sm:text-5xl font-extrabold text-light-text dark:text-dark-text tracking-tight">
              From Hyderabad, <span className="text-primary">For Hyderabad.</span>
            </h1>
          </div>
          <div className="mt-16 grid md:grid-cols-2 gap-12 items-center">
            <div className="prose prose-lg dark:prose-invert max-w-none text-slate-600 dark:text-slate-300">
              <p>
                With over 18 months of hands-on experience automating my family's local business, 
              ...
              <p>
                I realized that if my family's business was facing these issues, hundreds of other SMEs in Hyderabad
                must be in the same boat.
              </p>
              <p>
                I started Hyderabad Automations to bring the power of efficiency to other local businesses. 
                We're not a big, faceless corporation; we're a local partner dedicated to understanding and solving your specific problems. 
            ...
            <div>
                <img 
                    ...
                    alt="Founder of Hyderabad Automations" 
